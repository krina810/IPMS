 ...
 * @author Krina
 */
@WebServlet(name = "ProfileeditMtd", urlPatterns = {"/ProfileeditMtd"})
public class ProfileeditMtd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (Des) {
                case "ProjectManager":
                    response.sendRedirect("Pmanageraccount.jsp");
                    break;
                case "TeamLeader":
                    response.sendRedirect("Tlaccount.jsp");
                    break;
                case "Developer":
                    response.sendRedirect("Devaccount.jsp");
                    break;
