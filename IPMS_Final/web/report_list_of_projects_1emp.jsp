...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
       	<h2> List OF Projects handled by Employee </h2>
        <div class="col_w630 float_l">
        	
             <div id="contact_form">

                <form method="post" name="contact" action="report_list_emp_disp.jsp">
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select EmployeeID from Employee where Designation='ProjectManager'"); 
       String ids;
