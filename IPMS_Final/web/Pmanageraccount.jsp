<%-- 
    Document   : Pmanageraccount
    Created on : Apr 27, 2014, 6:57:14 PM
    Author     : Krina
--%>
...
3.Project Name: tasks</textarea>
        ...
        <div id="templatemo_sidebar">
            ...
            <div class="sb_box">
                ...
                <ul class="tmo_list">
             		 <li><a href="Pveiwemployee.jsp">View TeamLeaders</a></li>
                       <!-- <li><a href="Pveiwclient.jsp">View Clients</a></li>	-->	
                        ...
                        <li><a href="setPrototype.jsp">Set Prototype</a></li>
