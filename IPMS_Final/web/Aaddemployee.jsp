<%-- 
    Document   : Aaddemployee
    Created on : Apr 26, 2014, 5:12:29 PM
    Author     : Krina
--%>
             ...
             <div id="contact_form">
                ...
                <form method="post" name="contact" action="EmployeeaddMtd">
                    ...
                    <table class="cleaner h10">   
                        <tr><td>EmployeeID:</td><td><input type="text" name="empid" id="empid" onblur="Empty(document.getElementById('empid'), 'Textbox is empty, Please Enter a Value');"/></td></tr>
                        <tr>
<td> Name:</td><td><input type="text" id="author" name="author" value="First Name" onblur="Empty(document.getElementById('author'), 'Textbox is empty, Please Enter a Value');" />
    <input type="text" id="author1" name="author1" value="Middle Name"  />
    <input type="text" id="author2" name="author2" value="Last Name" /></td></tr>
...
<td>Contact no:</td><td><input type="text" id="contactno" name="contactno" onblur="onlynumbers(document.getElementById('contactno'));" /></td></tr>
               <!-- <div class="cleaner h10"></div>-->
<%--<tr>
<td>Department ID:</td><td><input type="text" id="dep" name="dep" onblur="Empty(document.getElementById('dep'), 'Textbox is empty, Please Enter a Value');" /></td></tr>
            <!-- <div class="cleaner h10"></div>-->--%>
<tr>
<td>Designation:</td><td><Select id="desg" name="desg" onblur="Empty(document.getElementById('desg'), 'Textbox is empty, Please Enter a Value');" />
    <option></option>
...
<tr>
<td>DOB:</td><td> <select  name="dobd" id="dobd"onblur="Empty(document.getElementById('dobd'), 'Textbox is empty, Please Enter a Value');" >
              <option> Day </option>
            ...
            </select> <select  name="dobm" id="dobm"onblur="Empty(document.getElementById('dobm'), 'Textbox is empty, Please Enter a Value');">
              <option> Month </option>
            ...
            </select>   <select class="" name="doby" id="doby" onblur="Empty(document.getElementById('doby'), 'Textbox is empty, Please Enter a Value');">
              <option> Year </option>
              ...
              <option value="1920"> 1920 </option>
                 ...
                 <!-- <div class="cleaner h10"></div>-->
<tr>
<td>DOJ:</td><td> <select  name="dojd" id="dojd" onblur="Empty(document.getElementById('dojd'), 'Textbox is empty, Please Enter a Value');">
              <option> Day </option>
              <option value="1"> 1 </option>
              <option value="2"> 2 </option>
              <option value="3"> 3 </option>
              ...
              <option value="30"> 30 </option>
              <option value="31"> 31 </option>
            </select> <select  name="dojm" id="dojm"onblur="Empty(document.getElementById('dojm'), 'Textbox is empty, Please Enter a Value');">
              <option> Month </option>
              <option value="January"> January </option>
              <option value="February"> February </option>
              <option value="March"> March </option>
              ...
              <option value="November"> November </option>
              <option value="December"> December </option>
            </select>   <select  name="dojy" id="dojy"onblur="Empty(document.getElementById('dojy'), 'Textbox is empty, Please Enter a Value');">
              <option> Year </option>
              <option value="2038"> 2038 </option>
              <option value="2037"> 2037 </option>
              <option value="2036"> 2036 </option>
...
<input type="checkbox" id="input_22_8" name="Skill" value="Windows" />
              Windows &nbsp</td></tr>
                    <div class="cleaner h10"></div>
<tr align="left"><td><input type="submit"  name="act" id="submit" value="Submit" /></td><td>
