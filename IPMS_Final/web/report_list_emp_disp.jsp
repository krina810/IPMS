<%-- 
    Document   : report_list_emp_disp
    Created on : May 1, 2014, 1:31:44 PM
    Author     : Krina
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
     ...
     <tr><th>EmployeeID</th><th>ProjectID</th><th>Project Title</th><th>Project Type</th><th>Project Desc</th><th>Client ID</th><th>Project Start date</th><th>Project Deadline</th></tr>          
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select * from Project where ProjectManagerID='"+a+"'"); 
       String ids;
         while(rs.next())
         {
        %>     
