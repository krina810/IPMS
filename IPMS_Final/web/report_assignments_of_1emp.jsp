<%-- 
    Document   : report_assignments_of_1emp
    Created on : Apr 29, 2014, 2:55:42 PM
    Author     : Admin
--%>
    ...
    <div id="templatemo_main">
        ...
        <div class="col_w630 float_l">
             ...
             <div id="contact_form">
                ...
                <form method="post" name="contact" action="report_ass_empdisp.jsp">
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select EmployeeID from Employee where Designation='Developer'"); 
       String ids;
