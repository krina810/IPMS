<%-- 
    ...
    Created on : Apr 26, 2014, 6:21:05 PM
    Author     : Admin
--%>

<%-- 
    Document   : manageraccount
    Created on : Apr 2, 2014, 10:54:35 PM
    Author     : Admin
--%>
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <p align="right"> Welcome <a href=ProfileMtd><%=ss.getAttribute("id")%></a>&nbsp; <a href=index.jsp>Logout</a> </p>
            ...
            <ul>
                        		<li><a href="Adminaccount.jsp" class="selected">My Dashboard</a>
                    <ul>
                        <li><a href="report_allprojects.jsp">Projects</a></li>
                        <li><a href="viewemployee.jsp">Teams</a></li>
		...
		<li><a href="report.jsp">Reports</a></li>
                <li><a href="MyMailComposer.jsp">Mails</a></li> 
       </ul>
            <br style="clear: left" />
...
3.Project Name: tasks</textarea>
        ...
        <div id="templatemo_sidebar">
            ...
            <div class="sb_box">
                ...
                <ul class="tmo_list">
             		<li><a href="Aaddproject.jsp">New Project</a></li>
                        <li><a href="Aaddemployee.jsp">Add Employee</a></li>
                        <%--<li><a href="Aadddes.jsp">Add Designation</a></li>
                        <li><a href="Aadddept.jsp">Add Department</a></li>--%>
                    	<li><a href="Aaddclient.jsp">Add Client</a></li>
                        <li><a href="Aviewemployee.jsp">View Employees</a></li>
                        <li><a href="Aviewclient.jsp">View Clients</a></li>	
                        <!--<li><a href="Aassignproject.jsp">Assign Project</a></li>-->
                        <li><a href="Agenerate.jsp">Progress</a></li>
            </div>       
...
<div id="templatemo_footer_wrapper">
    <div id="templatemo_footer">
        ...
        <a href="http://www.templatemo.com">Free CSS Templates</a>
        <div class="cleaner"></div>
    </div>
</div> 
