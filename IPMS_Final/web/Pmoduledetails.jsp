<%-- 
    Document   : Pmoduledetails
    Created on : Apr 26, 2014, 6:38:42 PM
    Author     : Admin
--%>
       ...
       <h2>Module Details:</h2>
        <div class="col_w630 float_l">
             ...
             <div id="contact_form">
                 ...
                 <form method="post" name="contact" action="ModuleaddMtd">
...
<tr><td>Module ID:</td><td><input type="text" id="modid" name="modid" onblur="Empty(document.getElementById('modid'), 'Textbox is empty, Please Enter a Value');"" /></td></tr>
                 <!--  <div class="cleaner h10"></div>-->
 <!--<tr><td>Project ID:</td><td><input type="text" id="pid" name="pid" onblur="Empty(document.getElementById('pid'), 'Textbox is empty, Please Enter a Value');"" /></td></tr>
         -->        
<tr><td>Module Description:</td><td><textarea id="text" name="text"onblur="Empty(document.getElementById('text'), 'Textbox is empty, Please Enter a Value');"></textarea></td></tr>
                 <!--   <div class="cleaner h10"></div>-->  
                                
<!--<tr><td>Module Name:</td><td><input type="text" id="mname" name="mname"/></td></tr>
           <!--  <div class="cleaner h10"></div>-->
                               <%
...
<tr><td>Start Date:</td><td> <select name="sdd" id="sdd">
              <option> Day </option>
              ...
              <option value="1920"> 1920 </option>
                    ...
                    <!--<div class="cleaner h10"></div>-->
<tr><td>Deadline:</td> <td><select  name="dd" id="dd">
              <option> Day </option>
              <option value="1"> 1 </option>
              <option value="2"> 2 </option>
              <option value="3"> 3 </option>
