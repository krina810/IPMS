<%-- 
    Document   : report_module_disp
    Created on : May 1, 2014, 12:56:15 AM
    Author     : Krina
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
     ...
     <tr><th>ModuleID</th><th>ProjectID</th><th>EmployeeID</th><th>Module Desc</th><th>Module Start Date</th><th>Module DeadLine</th>          
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select * from Module where ProjectID='"+a+"'"); 
       String ids;
         while(rs.next())
         {
        %>     
                            ...
                            <tr align="center"><td><%=rs.getString("ModuleID")%></td>
