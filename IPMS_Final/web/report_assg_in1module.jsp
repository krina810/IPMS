<%-- 
    Document   : report_assg_in1module
    Created on : May 1, 2014, 1:17:13 AM
    Author     : Krina
--%>
    ...
    <div id="templatemo_main">
        ...
        <div class="col_w630 float_l">
             ...
             <div id="contact_form">
                ...
                <form method="post" name="contact" action="report_ass_disp.jsp">
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select ModuleID from Module"); 
       String ids;
         
        %>
<tr>
<td>Select Module:</td><td><select  name="mid" id="pid">
        
               <% while(rs.next()){ %>
                                 
            <%ids=rs.getString("ModuleID");%>
