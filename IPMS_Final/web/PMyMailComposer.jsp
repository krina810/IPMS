<%-- 
    Document   : PMyMailComposer
    Created on : Apr 26, 2014, 11:48:08 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_header">
                ...
                <p align=right> Welcome <a href=PProfile.jsp><%=ss.getAttribute("id")%></a>&nbsp; <a href=index.jsp>Logout</a> </p>

                <div id="templatemo_menu" class="ddsmoothmenu">           
                    <ul>
                        <li><a href="manageraccount.jsp" >Myaccount</a>
