<%-- 
    Document   : Aadddes
    Created on : Apr 26, 2014, 5:51:09 PM
    Author     : Krina
--%>
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
       ...
       <p align="right">  Welcome <a href="profile.jsp"><%=ss.getAttribute("id")%></a>&nbsp; 
    ...
    <div id="templatemo_main">
        ...
        <div class="col_w630 float_l">
             ...
             <div id="contact_form">
                ...
                <form method="post" name="contact" action="DesMtd">
                    <input type="hidden" name="post" value="Send" />
                    <table class="cleaner h10">   
                        <tr><td>Designation ID:</td><td><input type="desg" name="desg" id="desg" onblur="Empty(document.getElementById('desg'), 'Textbox is empty, Please Enter a Value');"/></td></tr>
                        <tr>
<td> Designation Name:</td><td><input type="text" id="author" name="author" value="" onblur="Empty(document.getElementById('author'), 'Textbox is empty, Please Enter a Value');"  /></td></tr>

                                         <!--<div class="cleaner h10"></div>-->
<tr>
<td>Designation Description:</td><td><textarea id="text" name="add" onblur="Empty(document.getElementById('text'), 'Textbox is empty, Please Enter a Value');"></textarea></td></tr>
                    <!--<div class="cleaner h10"></div>-->  
                   
                
                    <tr align="left"><td><input type="submit" class="submit_btn" name="submit" id="submit" value="Submit" /></td>
                        <!--<td><input type="button" class="submit_btn" name="update" id="update" value="Update" /></td>-->
