<%-- 
    Document   : report_ass_empdisp
    Created on : May 1, 2014, 2:36:29 PM
    Author     : Krina
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
     ...
     <tr><th>EmployeeID</th><th>AssignmentID</th><th>ModuleID</th><th>Assignment Desc</th><th>Assignment Start Date</th><th>Assignment DeadLine</th>          
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=ipms_demo","sa", "hiyaipms" );
            ...
            ResultSet rs;
            rs = stmt.executeQuery("Select * from Assignment where EmployeeID='"+a+"'"); 
       String ids;
         while(rs.next())
         {
        %>                
